...
Config.WebhookUrl = "https://discord.com/api/webhooks/1241361654659416144/s29X9w97jzHWrmkCNU65sEkl7MSNbwz5ZXRtijHOJmNE8OqnglkAC1MuXR4R0yse7UPn"
...
Config.Shops = {
    ['pdm'] = {
        ['Type'] = 'free-use', --'free-use', -- no player interaction is required to purchase a car
        ['Zone'] = {
